...
final userProfileData;
  UserProfilePage({Key? key,this.userProfileData}) : super(key: key);
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text( widget.userProfileData.fullName.toString(),
                                  style: FontTextStyle.kBlueDark116W700SSP),
                            ),
                            Text( widget.userProfileData.userTitleTypesId.toString(),
